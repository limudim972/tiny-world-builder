...
- Front/right/left minimap modes should switch to elevation-style bars whose row count grows and shrinks with the tallest live building stack in view, the front side should follow the home-board arrow, and the minimum row should stay empty when nothing is built.
